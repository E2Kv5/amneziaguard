...
class AmneziaProxyController @Inject constructor(
    ...
    // No VPN is active during the spike, so nothing needs to be excluded.
    private var protector: SocketProtector = SocketProtector { 0 }
     ...
     */
    suspend fun start(confText: String, tunnelName: String = "awgproxy"): Result<Int> =
